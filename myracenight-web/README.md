# MyRaceNight Frontend v42

## 🆕 What's New in v42

### Previous Horses Tab
- New "Previous Horses" tab in the Horses page
- Import horses from past events without re-entering data
- Filter by source:
  - All My Events (default)
  - My Events (Organiser)
  - Club Events
  - Specific Event (dropdown)
- Duplicate detection shows which horses already exist
- One-click import with automatic approval
