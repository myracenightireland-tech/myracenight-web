...
export default function MyEventsPage() {
  ...
  const handleSelectHostEvent = async (event: Event) => {
    // Use selectEvent to properly load and set the event
                ...
                <div className="space-y-3">
                  {hostingEvents.map((event) => (
                    ...
                    >
                      <Card 
                        hover 
                        className="transition-all hover:border-gold/30"
                      >
                ...
                <div className="space-y-3">
                  {attendingEvents.map(({ event, ticket }) => (
                    ...
                    >
                      <Card 
                        hover 
                        className="transition-all hover:border-racing-green-light/30"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
