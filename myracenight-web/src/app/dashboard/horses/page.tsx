          ...
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <Card className="max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                {selectedHorse.silksDescription && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-400 mb-2">SILKS DESCRIPTION</h3>
                    <p className="text-white">{selectedHorse.silksDescription}</p>
                  </div>
                )}
