...
import { Event, Race, Horse as HorseType } from '@/types';
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href={`/dashboard/races?eventId=${id}`}>
                  <Button variant="ghost" size="sm">
                    Manage Races
                  </Button>
                </Link>
              ...
              {races.length === 0 ? (
                <div className="text-center py-8 text-gray-400">
                  ...
                  <p className="text-sm mt-1">Races will be auto-generated when you publish the event</p>
                </div>
              ) : (
                <div className="space-y-3">
                    ...
                    <div key={race.id} className="flex items-center justify-between p-3 bg-night-lighter rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">{race.horses?.length || 0} horses</p>
                        </div>
                      </div>
                      <Badge variant={
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <div className="space-y-3">
                ...
                {event.status === 'LIVE' && (
                  <Button className="w-full" variant="secondary" leftIcon={<CheckCircle className="w-5 h-5" />}>
                    End Event
                  </Button>
                )}
            ...
            <Card>
              ...
              <div className="p-3 bg-night-lighter rounded-lg mb-3">
                ...
                <p className="text-sm font-mono break-all">
                  myracenight.com/e/{event.slug}
                </p>
              </div>
              <Button variant="secondary" className="w-full" leftIcon={<Share2 className="w-5 h-5" />}>
                Copy Link
              </Button>
            </Card>
