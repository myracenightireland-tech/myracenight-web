          ...
          <Card className="max-w-4xl mx-auto">
            ...
            <div className="py-8 text-center">
              ...
              {currentRace.status === 'IN_PROGRESS' && (
                <div>
                  <div className="w-24 h-24 bg-gold/20 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
                    <span className="text-5xl">🏇</span>
                  </div>
                  <p className="text-xl text-gold mb-4">Race in Progress!</p>
                ...
                <div>
                  ...
                  {currentRace.winningPosition && horsesInRace[currentRace.winningPosition - 1] && (
                    <p className="text-2xl font-bold">
                      Winner: {horsesInRace[currentRace.winningPosition - 1].horseName}
                    </p>
                  )}
                </div>
              )}
