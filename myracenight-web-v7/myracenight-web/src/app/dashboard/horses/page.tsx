...
export default function HorsesPage() {
    ...
    try {
      ...
      for (const horse of unassigned) {
        const raceWithSpace = races.find(race => {
          ...
          return horsesInRace < horsesPerRace;
        });
  ...
  const horsesPerRace = currentEvent?.horsesPerRace || 8;
  const totalSlots = races.length * horsesPerRace;
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-8">
        ...
        <Card className="mb-6 bg-night-light">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div className="w-px h-12 bg-night-lighter" />
              <div>
                <p className="text-sm text-gray-400">Assigned to Races</p>
                <p className="text-2xl font-bold">{assignedCount} / {totalSlots}</p>
              </div>
            </div>
        ...
        {races.length > 0 && (
          <Card className="mb-6">
            <h3 className="text-lg font-semibold mb-4">Race Assignment</h3>
          ...
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <div className="bg-night-light rounded-xl max-w-2xl w-full max-h-[90vh] overflow-auto">
              <div className="p-6 border-b border-night-lighter flex items-center justify-between">
                <h2 className="text-xl font-bold">{selectedHorse.horseName}</h2>
                <button 
          ...
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <div className="bg-night-light rounded-xl max-w-md w-full">
              <div className="p-6 border-b border-night-lighter">
                <h2 className="text-xl font-bold">Reject "{selectedHorse.horseName}"</h2>
              </div>
              <div className="p-6">
            ...
            <div className="bg-night-light rounded-xl max-w-md w-full">
              <div className="p-6 border-b border-night-lighter">
                <h2 className="text-xl font-bold">
                  {selectedHorse.approvalStatus === 'PENDING' ? 'Approve' : 'Assign'} "{selectedHorse.horseName}"
                </h2>
              </div>
              <div className="p-6">
                {selectedHorse.approvalStatus === 'PENDING' && (
